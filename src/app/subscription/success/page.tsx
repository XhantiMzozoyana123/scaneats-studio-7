...
function SubscriptionSuccessContent() {
  ...
  useEffect(() => {
    ...
    if (!reference) {
      setStatus('error');
      setErrorMessage('No payment reference found. Your transaction could not be verified.');
      return;
    }
      ...
      case 'success':
        return (
          <div className="flex flex-col items-center gap-4 text-center text-white">
            ...
            <p className="text-gray-300">Your subscription is now active. You will be redirected shortly.</p>
          </div>
        );
      case 'error':
        return (
